...
function waitForPeers(a1, a2, timeout) {
    return new Promise((resolve, reject) => {
        const timer = setTimeout(() => reject(new Error('Peer discovery timeout')), timeout);
        const check = () => {
...
function waitForMessage(agent, event, timeout) {
    return new Promise((resolve, reject) => {
...
function waitForSenderKeys(delay) {
