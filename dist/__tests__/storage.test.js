...
import { AgentDatabase, IdentityRepository, PeerRepository, GroupRepository, MessageRepository, SenderKeyRepository, } from '../storage/index.js';
let dataDir;
let database;
beforeEach(() => {
...
describe('SenderKeyRepository', () => {
    ...
    it('should update existing sender key', () => {
        ...
        expect(new Uint8Array(loaded.chain_key)).toEqual(new Uint8Array(32).fill(2));
    });
